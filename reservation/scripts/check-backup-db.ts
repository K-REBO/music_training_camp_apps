...
// @reservation.db.bkの中身を確認するスクリプト

console.log('🔍 Checking @reservation.db.bk contents...');

try {
  // バックアップファイルを使用してKVを開く
  const kv = await Deno.openKv("/home/bido/projects/music_training_camp_apps/reservation/@reservation.db.bk");
  ...
  console.error('❌ Error reading backup database:', error);
}
